...
Description:
    This defines the CDialog-based MFC class to handle the properties dialog.
...
{
public:
	CDialogProperties(UCamera * Camera, CWnd* pParent = NULL);   // standard constructor
    BOOL OnInitDialog();
